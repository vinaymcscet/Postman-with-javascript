...
addParam.addEventListener('click', () => {
    ...
    let string = `
    <div class="row mb-3">
        <label for="inputEmail3" class="col-md-2 col-form-label">Parameter ${addedParamCount + 2}</label>
        <div class="col-md-4">
...
submit.addEventListener('click', () => {
    ...
    // If the request type is POST, invok the fetch api to create a post request 
    if (requestType == 'GET') {
        fetch(url, {
                method: 'GET',
            })
